...
// var polylineCoords = [
//   [41.9250790, 42.0127326],
//   [41.9245362, 42.0110750],
//   [41.9255141, 42.0105493],
//   [41.9266994, 42.0146155],
//   [41.9263722, 42.0148408],
//   [41.9257296, 42.0148623],
//   [41.9240772, 42.0154846],
//   [41.9225366, 42.0120084],
//   [41.9241331, 42.0112520]
// ];
...
var map = L.map('map').setView([avgLat, avgLng], 17.2);
...
function animateBreathing(circle) {
  ...
  var minRadius = 9; // Define the minimum radius for the circle
...
var startPoint = L.circleMarker(polylineCoords[0], { color: 'red', fillColor: 'blue', fillOpacity: 1, radius: 20 }).addTo(map).bindPopup('Start Point');

var endCircle = L.circleMarker(polylineCoords[polylineCoords.length - 1], { color: 'black', fillColor: 'blue', fillOpacity: 1, radius: 20 }).addTo(map).bindPopup('Start Point');
...
const thresholdDistance = 100; // Adjust the threshold distance as needed
          ...
          switch (i) {
              case 0:
                  ...
                  if (d1 < thresholdDistance && !audioPlayed) {
                    ...
                    var audioPlayer = new Audio('audio/left.mp3'); // Replace 'path/to/audio/file.mp3' with the actual path to your audio file
                    audioPlayer.play();
              ...
              case 2:
                  ...
                  if (d3 < thresholdDistance && !audioPlayed) {
                    console.log("d3 = ", d3);
                    // Display distance d1 to the screen
              ...
              case 3:
                  ...
                  if (d4 < thresholdDistance && !audioPlayed) {
                    // Display distance d1 to the screen
                    console.log("d4 = ", d4);
              ...
              case 4:
                  ...
                  console.log("d5 = ", d5);
                  if (d5 < thresholdDistance && !audioPlayed) {
                    // Display distance d1 to the screen
              ...
              case 5:
                  ...
                  if (d6 < thresholdDistance && !audioPlayed) {
                    console.log(d6);
                    // Display distance d1 to the screen
...
function startTracking() {
  ...
  updateLocation();
  var audioPlayer = new Audio('audio/start.mp3'); // Replace 'path/to/audio/file.mp3' with the actual path to your audio file
                    audioPlayer.play();
                    audioPlayed = true; 
}
// Call the updateLocation function to start tracking the user's location
